...
#if defined(unix) || defined(__unix) || defined(__unix__) || defined(__MACH__) || defined(__NetBSD__) || defined (__FreeBSD__) || defined (__OpenBSD__) || defined (__vita__) || defined (__SWITCH__)
#  define BOOST_DECL
...
#if defined(unix) || defined(__unix) || defined(__unix__) || defined(OS2) || defined(__MACH__) || defined(__NetBSD__) || defined (__FreeBSD__) || defined (__OpenBSD__) || defined (__vita__) || defined (__SWITCH__)
#include <sys/types.h>
#endif
